...
function HttpGet(url, headers, objectResponse) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, HttpCustom("get", url, undefined, headers, objectResponse)];
...
function HttpPost(url, data, headers, objectResponse) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, HttpCustom("post", url, data, headers, objectResponse)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
...
function HttpCustom(method, url, body, headers, objectResponse) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(typeof body == "object")) return [3 /*break*/, 2];
                    body = JSON.stringify(body);
                    if (!headers)
                        headers = {};
                    headers["Content-Type"] = "application/json";
                    return [4 /*yield*/, HttpCustom(method, url, body, headers, objectResponse)];
                case 1: return [2 /*return*/, _a.sent()];
                case 2:
                    req = {
                        method: method,
